...
- 📝 **[Note_Claude](https://github.com/kau10082/Note_Claude)**<br>
  ...
  <details><summary>中文</summary>
  一個 <code>/note-claud</code> 指令，把對話裡值得留下的主題原文歸檔進 Google Drive，日後再整理。
  </details>
...
- 💳 **[Card_Radar](https://github.com/kau10082/Card_Radar)**<br>
  ...
  <details><summary>中文</summary>
  錢包裡一堆卡，這筆該刷哪張？它把你的 Notion 當成個人信用卡資料庫，存放各卡的回饋規則，再依「實際拿到多少錢」而非帳面利率，即時挑出當下回饋最高的那張。用 <code>/card 全聯怎麼付</code> 這樣問就行。
  </details>
