...
大部分工具是我個人知識系統（2nd brain）的零件：素材先經保真萃取、通過查證，才進入 Obsidian／Notion 長期記憶。
*Most of these are parts of my second-brain system: material gets faithfully extracted and verified before it enters long-term memory in Obsidian / Notion.*
...
#### 📡 自動餵食・文獻雷達 · Automated literature feed
